	...
	<div align="center" style="font-size: 1.5em">
		...
		<form class="form" action="Registration" method="post"
			...
			<div class="row row-cols-auto" align="left" >
				<div class="col-md-4">
					<label for="inputFirstName" >Имя<span
						style="color: red">*</span></label> <input type="text"
						class="form-control" id="inputFirstName" name="firstName" required>
				</div>
				<div class="col-md-4">
					<label for="inputFirstName" class="formLabelCart">Фамилия<span
						style="color: red">*</span></label> <input type="text"
						class="form-control" id="inputFirstName" name="firstName" required>
				</div>
				<div class="col-md-4">
					<label for="inputFirstName" class="formLabelCart">Номер
						телефона<span style="color: red">*</span>
					</label> <input type="text" class="form-control" id="inputFirstName"
						name="firstName" required>
				</div>
				<div class="col-md-3">
					<label for="inputFirstName" class="form-label">Улица<span
						style="color: red">*</span></label> <input type="text"
						class="form-control" id="inputFirstName" name="firstName" required>
				</div>
				<div class="col-md-3">
					<label for="inputFirstName" class="form-label">Дом<span
						style="color: red">*</span></label> <input type="text"
						class="form-control" id="inputFirstName" name="firstName" required>
				</div>
				<div class="col-md-3">
					<label for="inputFirstName" class="form-label">Квартира</label> <input
						type="text" class="form-control" id="inputFirstName"
						name="firstName">
				</div>
				<div class="col-md-3">
					<label for="inputFirstName" class="form-label">Подъезд</label> <input
						type="text" class="form-control" id="inputFirstName"
						name="firstName">
				</div>
